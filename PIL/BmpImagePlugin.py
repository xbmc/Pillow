    ...
    def _bitmap(self, header=0, offset=0):
        ...
        # ---------------------------------------------- Windows Bitmap v2 to v5
            ...
            if file_info['header_size'] >= 40:  # v3 and OS/2
                ...
                self.info["dpi"] = tuple(map(
                    lambda x: int(math.ceil(x / 39.3701)), file_info[
                        'pixels_per_meter']))
        ...
        if file_info['compression'] == self.BITFIELDS:
            SUPPORTED = {
                32:
                [(0xff0000, 0xff00, 0xff, 0x0), (0xff0000, 0xff00, 0xff, None),
                 (0xff0000, 0xff00, 0xff, 0xff000000), (0x0, 0x0, 0x0, 0x0)],
            ...
            if file_info['bits'] in SUPPORTED:
                if file_info['bits'] == 32 and file_info[
                    ...
                    raw_mode = MASK_MODES[(file_info['bits'], file_info[
                        'rgba_mask'])]
                    self.mode = "RGBA" if raw_mode in ("BGRA",
                                                       "BGRT") else self.mode
                elif file_info['bits'] in (24, 16) and file_info[
                        'rgb_mask'] in SUPPORTED[file_info['bits']]:
                    raw_mode = MASK_MODES[(file_info['bits'], file_info[
                        'rgb_mask'])]
                else:
        ...
        if self.mode == "P":  # Paletted for 1, 4 and 8 bit images
            ...
            if not (0 < file_info['colors'] <= 65536):
                ...
                greyscale = True
                indices = (0, 255) if file_info['colors'] == 2 else list(range(
                    file_info['colors']))
