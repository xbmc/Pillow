...
class TestImageCms(PillowTestCase):
    ...
    def test_profile_tobytes(self):
        ...
        self.assertEqual(
            ImageCms.getProfileName(p), ImageCms.getProfileName(p2))
        self.assertEqual(
            ImageCms.getProfileDescription(p),
    ...
    def test_extended_information(self):
        ...
        self.assertEqual(p.clut, {0: (False, False, True),
                                  1: (False, False, True),
                                  2: (False, False, True),
                                  3: (False, False, True)})
        ...
        self.assertEqual(p.intent_supported, {0: (True, True, True),
                                              1: (True, True, True),
                                              2: (True, True, True),
                                              3: (True, True, True)})
