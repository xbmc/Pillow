...
static PyObject *_get_handles_eof(ImagingDecoderObject *decoder) {
...
static struct PyGetSetDef getseters[] = {
    {"handles_eof", (getter)_get_handles_eof, NULL,
     "True if this decoder expects to handle EOF itself.", NULL},
...
PyObject *PyImaging_TiffLzwDecoderNew(PyObject *self, PyObject *args) {
  ImagingDecoderObject *decoder;
...
PyObject *PyImaging_MspDecoderNew(PyObject *self, PyObject *args) {
  ImagingDecoderObject *decoder;
