...
static void unpackLA(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
static void unpackLAL(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* LA, line interleaved */
  for (i = 0; i < pixels; i++) {
...
void ImagingUnpackRGB(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* RGB triplets */
  for (i = 0; i < pixels; i++) {
    out[R] = in[0];
...
void unpackRGB16B(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
static void unpackRGBL(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
static void unpackRGBR(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* RGB, bit reversed */
  for (i = 0; i < pixels; i++) {
    out[R] = BITFLIP[in[0]];
...
void ImagingUnpackBGR(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* RGB, reversed bytes */
  for (i = 0; i < pixels; i++) {
    out[R] = in[2];
...
static void ImagingUnpackBGRX(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
static void ImagingUnpackXRGB(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* RGB, leading pad */
  for (i = 0; i < pixels; i++) {
    out[R] = in[1];
...
static void ImagingUnpackXBGR(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
static void unpackRGBALA(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
static void unpackRGBALA16B(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
static void unpackRGBa(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* premultiplied RGBA */
  for (i = 0; i < pixels; i++) {
    int a = in[3];
...
static void unpackRGBAL(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
void unpackRGBA16B(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
...
static void unpackARGB(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* RGBA, leading pad */
  for (i = 0; i < pixels; i++) {
    out[R] = in[1];
...
static void unpackABGR(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* RGBA, reversed bytes */
  for (i = 0; i < pixels; i++) {
    out[R] = in[3];
...
static void unpackBGRA(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* RGBA, reversed bytes */
  for (i = 0; i < pixels; i++) {
    out[R] = in[2];
...
static void unpackBGRT(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
  /* RGBA, reversed bytes */
...
static void unpackCMYKI(UINT8 *out, const UINT8 *in, int pixels) {
  int i;
